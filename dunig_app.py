    ...
    if st.session_state.registered:
        ...
        st.markdown(f"""
            <div class='welcome-card'>
                <h1 style='color: #D4AF37;'>💎 ¡BIENVENIDOS A D'UNIG LUXURY tu mejor aliado comercial 🤝!</h1>
            ...
            if st.form_submit_button("SOLICITAR REGISTRO"):
                if r_nombre_tienda and r_email and r_whatsapp and r_foto_portada and r_referencia_pago:
                    try:
                        ...
                        # Inserción (Aquí es donde daba el error)
                        # Nota: Asegúrate de que todas estas columnas existan en Supabase
                        ...
                        st.error(f"Error al registrar: Verifica que todas las columnas existan en Supabase. Detalles técnicos ocultos por seguridad.")
                else:
                    st.error("Completa todos los campos.")

# --- RESTO DEL CÓDIGO (MALL Y PANEL) ---
# ... (Igual al anterior para no saturar el espacio)